...
function showPatientAgeRange() {
    ...
    <td>";
        echo xlt('From');
            echo "<input name='age_from' class='numeric_only' type='text' id='age_from' value='";if(isset($_POST["age_from"]) && $_POST["age_from"] != null) { echo attr($_POST["age_from"]); };
            echo "' size='3' maxlength='3'/>";
        echo xlt('To{{range}}');
            echo "<input name='age_to' class='numeric_only' type='text' id='age_to' value='";if(isset($_POST["age_to"]) && $_POST["age_to"] != null) { echo attr($_POST["age_to"]); };
            echo "' size='3' maxlength='3'/>
    </td>";
}
