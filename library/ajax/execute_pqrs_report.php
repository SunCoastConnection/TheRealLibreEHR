<?php
/**
// COPYRIGHT 2016 Bryan lee <leebc 11 at acm dot org>
 * Run a PQRS engine report.
 *
...
if (!empty($GLOBALS['pqrs_report_nice'])) {
  proc_nice($GLOBALS['pqrs_report_nice']);
}
