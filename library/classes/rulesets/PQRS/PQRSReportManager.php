...
error_log("DEBUG PQRSReportManager.php -- POSTed us with action=".$myaction."  report_id=".$myreport_id."  report_new_name = ".$report_new_name.".");
	...
	if ( $myaction=='RENAME' && $myreport_id != '' && $myreport_new_name != '' ) {
		//$query = "REPLACE INTO report_results (report_id, field_id, field_value) VALUES (".$myreport_id.", 'title', '".$myreport_new_name."')  WHERE report_id = '".$myreport_id."' AND field_id = 'title';";
