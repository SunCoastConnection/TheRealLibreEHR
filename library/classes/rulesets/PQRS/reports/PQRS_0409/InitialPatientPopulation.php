<?php
/**
 * PQRS Measure 0409 -- Initial Patient Population
 *
...
class PQRS_0409_InitialPatientPopulation implements PQRSFilterIF
{
...
" AND (b2.code = codelist_b.code AND codelist_b.type = 'pqrs_0409_b'); ";
