<?php
/**
 * PQRS Measure 0072 -- Initial Patient Population
 *
...
class PQRS_0072_InitialPatientPopulation implements PQRSFilterIF
{
...
" AND (b2.code = codelist_b.code AND codelist_b.type = 'pqrs_0072_b'); ";
