<?php
/**
 * PQRS Measure 0326 -- Initial Patient Population
 *
...
class PQRS_0326_InitialPatientPopulation implements PQRSFilterIF
{
...
" AND (b1.code = codelist_a.code AND codelist_a.type = 'pqrs_0326_a') ".
