<?php
/**
 * PQRS Measure 0453 -- Initial Patient Population
 *
...
class PQRS_0453_InitialPatientPopulation extends PQRSFilter
{
...
" AND (b1.code = codelist_a.code AND codelist_a.type = 'pqrs_0453_a') ".
