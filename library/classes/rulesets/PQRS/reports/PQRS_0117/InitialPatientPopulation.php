<?php
/*
 * PQRS Measure 0117 -- Initial Patient Population
 *
...
" AND (b2.code = codelist_b.code AND codelist_b.type = 'pqrs_0117_b')".
" AND (b1.code = codelist_a.code AND codelist_a.type = 'pqrs_0117_a'); ";
