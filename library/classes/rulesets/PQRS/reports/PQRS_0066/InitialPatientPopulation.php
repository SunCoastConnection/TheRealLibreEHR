...
" INNER JOIN pqrs_efficience_and_cost_reduction AS codelist_a ON (b1.code = codelist_a.code)".
" INNER JOIN pqrs_efficience_and_cost_reduction AS codelist_b ON (b2.code = codelist_b.code)".
