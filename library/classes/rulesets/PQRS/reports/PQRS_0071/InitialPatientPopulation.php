<?php
/**
 * PQRS Measure 0071 -- Initial Patient Population
 *
...
class PQRS_0071_InitialPatientPopulation implements PQRSFilterIF
{
...
" AND (b2.code = codelist_b.code AND codelist_b.type = 'pqrs_0071_b'); ";
