...
class Immunizations
{
    public static function checkDtap( PQRSPatient $patient, $beginDate, $endDate )
    {
    ...
    public static function checkIpv( PQRSPatient $patient, $beginDate, $endDate )
    {
        $dobPlus42Days = date( 'Y-m-d 00:00:00', strtotime( '+42 day', strtotime( $patient->dob ) ) );
        $dobPlus2Years = date( 'Y-m-d 00:00:00', strtotime( '+2 year', strtotime( $patient->dob ) ) );
    ...
    public static function checkMmr( PQRSPatient $patient, $beginDate, $endDate )
    {
    ...
    public static function checkHib( PQRSPatient $patient, $beginDate, $endDate )
    {
    ...
    public static function checkHepB( PQRSPatient $patient, $beginDate, $endDate )
    {
    ...
    public static function checkVzv( PQRSPatient $patient, $beginDate, $endDate )
    {
    ...
    public static function checkPheumococcal( PQRSPatient $patient, $beginDate, $endDate )
    {
    ...
    public static function checkHepA( PQRSPatient $patient, $beginDate, $endDate )
    {
        $options = array( Medication::OPTION_COUNT => 2 );
        $dobPlus42Days = date( 'Y-m-d 00:00:00', strtotime( '+42 day', strtotime( $patient->dob ) ) );
        $dobPlus2Years = date( 'Y-m-d 00:00:00', strtotime( '+2 year', strtotime( $patient->dob ) ) );  
    ...
    public static function checkRotavirus( PQRSPatient $patient, $beginDate, $endDate )
    {
        $options = array( Medication::OPTION_COUNT => 4 );
        $dobPlus42Days = date( 'Y-m-d 00:00:00', strtotime( '+42 day', strtotime( $patient->dob ) ) );
        $dobPlus2Years = date( 'Y-m-d 00:00:00', strtotime( '+2 year', strtotime( $patient->dob ) ) );  
    ...
    public static function checkInfluenza( PQRSPatient $patient, $beginDate, $endDate )
    {
        $options = array( Medication::OPTION_COUNT => 2 );
	...
	public static function checkRotavirus_2014( PQRSPatient $patient, $beginDate, $endDate )
    {
        $options = array( Medication::OPTION_COUNT => 2 );
        $dobPlus42Days = date( 'Y-m-d 00:00:00', strtotime( '+42 day', strtotime( $patient->dob ) ) );
        $dobPlus2Years = date( 'Y-m-d 00:00:00', strtotime( '+2 year', strtotime( $patient->dob ) ) );  
