<?php
/**
 * PQRS Measure 0182 -- Initial Patient Population
 *
...
class PQRS_0182_InitialPatientPopulation implements PQRSFilterIF
{
...
" AND (b1.code = codelist_a.code AND codelist_a.type = 'pqrs_0182_a'); ";
