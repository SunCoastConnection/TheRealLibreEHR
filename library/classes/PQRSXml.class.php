<?php 
 ...
 // This program implements the XML Writer to generate PQRS 2016 XML.

require_once("XmlWriterOemr.class.php");

class PQRSXml extends XmlWriterOemr {
	...
	function add_registry($submission_method) {
		...
		$this->push('registry');
		$this->element('registry-name', $GLOBALS['pqrs_registry_name']); 
		$this->element('registry-id', $GLOBALS['pqrs_registry_id']); 
	...
	function add_pqrs_measures($arrStats) {
