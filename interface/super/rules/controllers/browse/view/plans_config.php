...
<div class="cdr-mappings">
    ...
    <div id="cdr_mappings_form-div" class="cdr-form">
        <div class="cdr-plans">
            ...
            <button type="button" class="btn btn-danger" id="delete_plan" style="display: none; background-color: red; color: white;"><?php echo out(xl('Delete Plan')); ?></button>
        </div>
        ...
        <div id="cdr_hide_show-div" style="display: none;">
            ...
            <div id="cdr-rules_cont">
                ...
                <div id="cdr_buttons_div" class="cdr-buttons-class">
                    <button onclick="cancelPlan();" id='cdr-button-cancel cp-negative'><?php echo out( xl( 'Cancel' )); ?></button>
                    <button onclick="submitPlan();" id='cdr-button-submit cp-submit'><?php echo out( xl( 'Submit' )); ?></button>
                </div>
            </div>
        </div>
    </div>
