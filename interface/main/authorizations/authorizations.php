...
$(document).ready(function(){
    $("#findpatients").click(function() { RestoreFrame(this); document.location.href='<?php echo $GLOBALS["web_root"]; ?>/modules/calendar/find_patient.php?no_nav=1&mode=reset'; return true; });
