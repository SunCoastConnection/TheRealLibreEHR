    ...
    <ul>
      ...
      <li><a class="collapsed_lv2"><span><?php xl('Other','e') ?></span></a>
        <ul>
          ...
          <?php if (acl_check('admin', 'users'   )) genMiscLink('RTop','adm','0',xl('Logs'),'logview/logview.php'); ?>
          <?php
          if($GLOBALS['erx_enable'] && ($newcrop_user_role['newcrop_user_role'] || $GLOBALS['erx_enable'])) {
     ...
     <?php // 2016-02-02 leebc -- Adding menu section for PQRS 
      ...
      <li><a class="collapsed_lv2"><span><?php xl('Physician Quality Reporting System','e') ?></span></a>
        <ul>
          ...
          <?php genMiscLink('RTop','rep','0',xl('Client Database Import'),'main/PQRS/import_data.php'); ?>
        </ul>
      </li>
      <?php }?>
