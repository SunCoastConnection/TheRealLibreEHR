    ...
    <form name='facility' method='post' action="../super/save_edit_settings.php" target="_parent">
      ...
      <table border=0 cellpadding=0 cellspacing=1 style="width:630px;">
        <tr>
          ...
          <td width='220px'>
            <input
              ...
              name='facility'
              size='20'
              value='<?php echo htmlspecialchars($facility['name'], ENT_QUOTES) ?>'
            />
            <font class="mandatory">&nbsp;*</font>
          </td>
          <td width='150px'>
            <span class='text'><?php xl('Legal Entity','e'); ?>: </span>
          </td>
          <td width='220px'>
            <input
              type='entry'
              name='alias'
              size='20'
              value='<?php echo htmlspecialchars($facility['alias'], ENT_QUOTES) ?>'
            />
            <font class="mandatory">&nbsp;*</font>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <input
              ...
              size=20
              name=street
              value="<?php echo htmlspecialchars($facility["street"], ENT_QUOTES) ?>"
            />
          </td>
          <td width='200px'>
            <span class='text'><?php xl('Phone','e'); ?> <?php xl('as','e'); ?> (000) 000-0000:</span>
          </td>
          <td width='220px'>
            <input
              type='entry'
              name='phone'
              size='20'
              value='<?php echo htmlspecialchars($facility['phone'], ENT_QUOTES) ?>'
            />
          </td>
        </tr>
        <tr>
          ...
          <td>
            <input
              ...
              size=20
              name=city
              value="<?php echo htmlspecialchars($facility{"city"}, ENT_QUOTES) ?>"
            />
          </td>
          <td>
            <span class='text'><?php xl('Fax','e'); ?> <?php xl('as','e'); ?> (000) 000-0000:</span>
          </td>
          <td>
            <input
              type='entry'
              name='fax'
              size='20'
              value='<?php echo htmlspecialchars($facility['fax'], ENT_QUOTES) ?>'
            />
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            <input
              ...
              size=11
              name=federal_ein
              value="<?php echo htmlspecialchars($facility{"federal_ein"}, ENT_QUOTES) ?>"
            />
          </td>
        </tr>
        <tr>
          ...
          <td>
            <input
              ...
              size=20
              name=postal_code
              value="<?php echo htmlspecialchars($facility{"postal_code"}, ENT_QUOTES) ?>"
            />
          </td>
          <td width="21">
          ...
          <td>
            <input
              ...
              size=20
              name=facility_npi
              value="<?php echo htmlspecialchars($facility{"facility_npi"}, ENT_QUOTES) ?>"
            />
          </td>
        </tr>
        <tr>
          ...
          <td>
            <input
              ...
              size=20
              name=country_code
              value="<?php echo htmlspecialchars($facility{"country_code"}, ENT_QUOTES) ?>"
            />
          </td>
        </tr>
        <tr>
          ...
          <td>
            <input
              ...
              size=20
              name=website
              value="<?php echo htmlspecialchars($facility{"website"}, ENT_QUOTES) ?>"
            />
          </td>
          <td>
          ...
          <td>
            <input
              ...
              size=20
              name=email
              value="<?php echo htmlspecialchars($facility{"email"}, ENT_QUOTES) ?>"
            />
          </td>
        </tr>
        <tr>
          ...
          <td>
            <input
              ...
              value='1' <?php if ($facility['billing_location'] != 0) echo 'checked'; ?>
            />
          </td>
          <td rowspan='2'>
            <span class='text'>
              <?php xl('Accepts Assignment','e'); ?>
              <br>
              (<?php xl('only if billing location','e'); ?>):
            </span>
          </td>
          <td>
            <input
              ...
              value='1'
              <?php if ($facility['accepts_assignment'] == 1) echo 'checked'; ?>
            />
          </td>
        </tr>
        <tr>
          ...
          <td>
            <input
              ...
              value='1'
              <?php if ($facility['service_location'] == 1) echo 'checked'; ?>
            />
          </td>
          <td>&nbsp;</td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <input
              ...
              <?php if($GLOBALS['erx_enable']){ ?> onchange='return displayAlert()'
              <?php } ?>
              <?php echo $disabled;?>
            />
          </td>
        ...
        <tr>
          ...
          <td>
            <span class="text">Pick:&nbsp;
              <input
                type="color"
                id="colorPicker"
                onChange="changeColor('colorPicker')"
                value="<?php echo htmlspecialchars($facility{"color"}, ENT_QUOTES) ?>"
              />
            </span>
            <span>
              <input
        ...
        <tr>
          <td>
            <span class="text"><?php xl('Billing Attn','e'); ?>:</span>
          </td>
          <td colspan="4">
            <input
              type="text"
              name="attn"
              size="45"
              value="<?php echo htmlspecialchars($facility['attn'], ENT_QUOTES) ?>"
            />
          </td>
        </tr>
        <tr>
        ...
        <tr height="20" valign="bottom">
          <td colspan=2>
            <span class="text">
              <font class="mandatory">*</font> <?php echo xl('Required','e');?>
            </span>
          </td>
        </tr>
      </table>
