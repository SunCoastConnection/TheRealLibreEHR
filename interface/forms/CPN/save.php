...
$inc  = sqlStatement("SELECT MAX(pc_multiple)as multiple FROM libreehr_postcalendar_events");
...
//add next scheduled event to the calender for the clinician and this patient at encounter date plus six months
 sqlStatement("INSERT INTO libreehr_postcalendar_events SET " .
 						"pc_catid = 13, " .
 						"pc_multiple = '" .$poo . "', " .
