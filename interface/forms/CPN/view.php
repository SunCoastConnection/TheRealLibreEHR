...
Next Appointment Date : <input type="date" name='data35' value='<?php echo $obj{"data35"};?>'><br>
Next Appointment Start Time : <input type="time" name='data36' value='<?php echo $obj{"data36"};?>'>&nbsp;&nbsp;
End Time : <input type="time" name='data37' value='<?php echo $obj{"data37"};?>'> <br>
