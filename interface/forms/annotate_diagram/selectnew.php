...
<html>
<head>
<title><?php echo xlt('Select New Diagram for Annotation'); ?></title>
...
echo '<h4 class="text-center">'. xlt("Click Thumbnails to view then Click full image to select.") .'</h4>';
echo '<div id="diagram" class="diagram" style="text-align:left;"><ul>';
    ...
    echo '<div class="clear"></div>';
        ...
        echo '<p>'.xlt("There are no images in this gallery.").'</p>';
    }
echo '</ul></div>';
...
var SelectImage = function(obj) {
    ...
    if (opener.closed || !opener.SetDiagram( imgname, fname ))
        alert('<?php echo xls("The parent form was closed and lost scope; Close and try again."); ?>');
//    else{
