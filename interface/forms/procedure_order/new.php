          ...
          ?>
            ...
            <?php if(empty($formid) || empty($oprow['procedure_order_title'])) {?>
              ...
              <td width='1%' valign='top'>
                ...
                />
                <b><?php echo text($oprow['procedure_order_title']) ?></b>
              </td>
              <?php } ?>
              <td valign='top'>
                <input
                  ...
                  class='form-control'
                  size='50'
                  name='form_proc_type_desc[<?php echo $i; ?>]'
                  ...
                  style='width:auto; cursor:pointer;cursor:hand'
                  readonly
                />
              </td>
            </tr>
            <tr>
              <td valign='top'>
                <input
                  ...
                  value='<?php echo $ptid ?>'
                />
                <b><?php echo xlt('Diagnosis Codes'); ?>:</b>
              </td>
              <td>
                <input
                  type='text'
                  ...
                  title='<?php echo xla('Click to add a diagnosis'); ?>'
                  onfocus='this.blur()'
                  style='cursor:pointer; cursor:hand; width: auto;'
                  readonly
                />
              </td>
            </tr>
