...
<frameset rows="<?php if ($GLOBALS[$currenttheme]=='style_mycatalyst.css'){echo "162,$GLOBALS[titleBarHeight]"; }else{echo "$GLOBALS[logoBarHeight],$GLOBALS[titleBarHeight]";} ?>,*" cols="*" frameborder="NO" border="0" framespacing="0">
