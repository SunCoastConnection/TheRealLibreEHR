                    ...
                    <?php //
                        ...
                        ?>
                              ...
                              <tr class="text"  bgcolor='<?php echo $bgcolor; ?>'>
                                <td class="<?php echo $StringClass; ?>" ><?php if ((acl_check('search_payments') && (strtotime($payment_delete_from_date) < strtotime($RowSearch['check_date']))) || (substr($GLOBALS['payment_delete_begin_date'],0,1) == 'N')){?><a href="#" onClick="javascript:return DeletePayments(<?php echo htmlspecialchars($RowSearch['session_id']); ?>);" ><img src="../pic/Delete.gif" border="0"/></a><?php }?></td>
