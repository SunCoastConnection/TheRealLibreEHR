...
switch ($iter{'enc_user_id'}) {
    case $iter{'enc_user_id'} = $final_list[0]:
        $us0_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[1]:
        $us1_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[2]:
        $us2_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[3]:
        $us3_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[4]:
        $us4_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[5]:
        $us5_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[6]:
        $us6_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[7]:
        $us7_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[8]:
        $us8_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[9]:
        $us9_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[10]:
        $us10_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[11]:
        $us11_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[12]:
        $us12_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[13]:
        $us13_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[14]:
        $us14_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[15]:
        $us15_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[16]:
        $us16_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[17]:
        $us17_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[18]:
        $us18_user = $iter{'enc_user_id'};
        ...
        break;
    case $iter{'enc_user_id'} = $final_list[19]:
        $us19_user = $iter{'enc_user_id'};
...
if ($the_first_time == 1) {
  $user = $iter{'enc_user_id'};
  $first_user = $iter{'enc_user_id'};
...
if ($totals_only != 1) {
    ...
    if ($iter{'code_type'} === 'COPAY' || $iter{'code_type'} === 'Patient Payment' || $iter{'code_type'} === 'Insurance Payment' ) {
     ...
     if (($iter{'code_type'}) != 'Insurance Payment' AND ($iter{'code_type'}) != 'Patient Payment' AND $iter{'paytype'} != 'PCP') {
      ...
      print  "</span></td><td width=100><span class=text><center>" . text($iter{'enc_user_id'}). "</center>" ;
...
Printf ("<td width=70><span class=text><b><center>". xlt("Grand Totals for all") . ' ');
