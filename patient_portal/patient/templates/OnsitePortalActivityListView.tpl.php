...
<!-- UNCOMMENT TO SHOW ADDITIONAL COLUMNS
                <th id="header_Narrative"><?php echo xlt('Narrative'); ?><% if (page.orderBy == 'Narrative') { %> <i class='icon-arrow-<%= page.orderDesc ? 'up' : 'down' %>' /><% } %></th>
                <th id="header_TableAction"><?php echo xlt('Table Action'); ?><% if (page.orderBy == 'TableAction') { %> <i class='icon-arrow-<%= page.orderDesc ? 'up' : 'down' %>' /><% } %></th>
                <th id="header_TableArgs"><?php echo xlt('Table Args'); ?><% if (page.orderBy == 'TableArgs') { %> <i class='icon-arrow-<%= page.orderDesc ? 'up' : 'down' %>' /><% } %></th>
                <th id="header_ActionUser"><?php echo xlt('Action User'); ?><% if (page.orderBy == 'ActionUser') { %> <i class='icon-arrow-<%= page.orderDesc ? 'up' : 'down' %>' /><% } %></th>
                <th id="header_ActionTakenTime"><?php echo xlt('Action Taken Time'); ?><% if (page.orderBy == 'ActionTakenTime') { %> <i class='icon-arrow-<%= page.orderDesc ? 'up' : 'down' %>' /><% } %></th>
                <th id="header_Checksum"><?php echo xlt('Checksum'); ?><% if (page.orderBy == 'Checksum') { %> <i class='icon-arrow-<%= page.orderDesc ? 'up' : 'down' %>' /><% } %></th>
-->
            </tr>
        </thead>
        <tbody>
