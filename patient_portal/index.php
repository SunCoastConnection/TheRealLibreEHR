...
<div class="container text-center">
    ...
    <?php if (isset($_SESSION['password_update'])||isset($_GET['password_update'])) { 
      ...
      <div id="wrapper" class="centerwrapper" style="text-align:center;">
        <h2 class="title"><?php echo xlt('Please Enter a New Phrase'); ?></h2>
        <form action="get_patient_info.php" method="POST" onsubmit="return process_new_pass()" >
            <table style="width:100%">
                ...
                <tr>
                    <td class="algnRight"><?php echo xlt('Current Pass Phrase');?></td>
                    <td>
                        <input name="pass" id="pass" type="password" autocomplete="off" value="" />
                    </td>
                </tr>
                <tr>
                    <td class="algnRight"><?php echo xlt('New Pass Phrase');?></td>
                    <td>
                        <input name="pass_new" id="pass_new" type="password" />
                    </td>
                </tr>
                <tr>
                    <td class="algnRight"><?php echo xlt('Confirm New Pass Phrase');?></td>
                    <td>
...
?>  <!-- Main logon -->
    ...
    <img style="width:65%" src='<?php echo $GLOBALS['images_path']; ?>logo-full-con.png'/>
