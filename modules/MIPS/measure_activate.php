	...
	function quickSelect(specialty) {
		...
		switch(specialty) {
                        ...
                        case "MIPS-2 Anesthesiology":
                                mymeasurelist = [44,76,404,424,430,463];
                                break;
                        case "MIPS-3 Cardiology":
                                mymeasurelist = [5,6,7,8,47,118,128,130,226,236,238,243,317,322,323,324,326,344,345,374,402,431,438,441,442];
                                break;
                        case "MIPS-4 Dermatology":
                                mymeasurelist = [130,137,138,226,265,317,337,374,402,410,440];
                                break;
                        case "MIPS-5 Diagnostic Radiology":
                                mymeasurelist = [145,146,147,195,225,360,361,362,364,405,406,436];
                                break;
                        ...
                        case "MIPS-7 Emergency Medicine":
		   				...
		   				case "MIPS-8 Gastroenterology":
                                ...
                                break;
                        case "MIPS-9 General Practice/Family Medicine":
                                mymeasurelist = [1,5,6,7,8,24,39,47,48,50,65,66,91,93,109,110,111,112,113,116,117,119,126,128,130,134,154,155,181,226,236,238,243,317,326,331,332,333,337,338,342,370,374,383,387,394,398,400,401,402,408,412,414,418,431,438,441,442,443,444,464,468,472,474];
                                break;
                        case "MIPS-10 General Surgery":
                                mymeasurelist = [21,23,46,47,128,130,226,264,317,355,356,357,358,374,402];
                                break;
                        case "MIPS-11 Geriatrics":
                                mymeasurelist = [39,46,47,50,110,111,130,131,181,238,282,283,286,288,370,408,412,414,455,474];
                                break;
                        case "MIPS-12 Hospitalists":
                                mymeasurelist = [5,8,47,76,130,407];
                                break;
                        case "MIPS-13 Infectious Disease":
                                mymeasurelist = [110,111,130,205,338,340,407,464,474];
                                break;
                        case "MIPS-14 Internal Medicine":
                                mymeasurelist = [1,5,6,7,8,24,39,47,48,50,91,93,110,111,116,117,119,126,128,130,134,154,155,181,226,236,238,243,277,279,317,326,331,332,333,337,338,342,370,374,383,387,398,400,401,402,408,412,414,418,431,438,441,442,443,444,468,472,474];
                                break;
                        ...
                        case "MIPS-16 Mental Health/Behavioral Health/Dementia":
                                mymeasurelist = [128,130,134,181,226,282,283,286,288,317,325,370,374,383,391,402,411,431,468];
                                break;
                        case "MIPS-17 Nephrology":
                                mymeasurelist = [1,46,47,110,111,119,130,182,317,328,330,400,403,474];
                                break;
                        case "MIPS-18 Neurology":
                                mymeasurelist = [47,130,134,154,155,181,226,268,282,283,286,288,290,291,293,317,374,386,402,408,412,414,419,431,435];
                                break; 
                        case "MIPS-19 Neurosurgical":
                                mymeasurelist = [21,23,130,187,226,345,346,409,413,459,460,461,469,471,473];
                                break; 
                        case "MIPS-20 Obstetrics and Gynecology":
                                mymeasurelist = [47,48,50,110,111,112,128,130,226,236,265,317,374,402,418,422,428,429,431,432,433,434,443,448,472];
                                break;
                        case "MIPS-21 Oncology":
                                mymeasurelist = [47,102,110,111,130,143,144,226,250,317,374,402,431,449,450,451,452,453,454,455,456,457,474];
                                break;              
                        case "MIPS-22 Ophthalmology":
                                mymeasurelist = [12,14,19,117,130,141,191,192,226,303,374,384,385,388,389];
                                break;
                        case "MIPS-23 Orthopaedic Surgery":
                                mymeasurelist = [21,23,24,46,47,109,128,130,131,134,154,155,178,179,180,226,317,350,351,352,353,358,374,402,408,412,414,418,459,460,461,469,470,471,473];
                                break;
                        case "MIPS-24 Otolaryngology":
                                mymeasurelist = [21,23,47,65,91,93,110,111,128,130,154,155,226,265,277,279,317,331,332,333,357,358,374,398,402,431,464];
                                break;
                        case "MIPS-25 Pathology":
                                mymeasurelist = [249,250,395,396,397];
                                break;
                        case "MIPS-26 Pediatrics":
                                mymeasurelist = [65,66,91,93,110,134,205,391,394,398,402,444,464,467];
                                break;
                        case "MIPS-27 Physical Medicine":
                                mymeasurelist = [47,109,128,130,131,154,155,182,226,317,374,402,408,412,414,431,468];
                                break;
                        case "MIPS-28 Physical and Occupational Therapy":
                                mymeasurelist = [128,130,131,182,217,218,219,220,221,222,223];
                                break;          
                        case "MIPS-29 Plastic Surgery":
                                mymeasurelist = [21,23,130,226,317,355,356,357,358];
                                break;
                        case "MIPS-30 Podiatry":
                                mymeasurelist = [126,127,128,154,155,226];
                                break;
                        case "MIPS-31 Preventive Medicine":
                                mymeasurelist = [1,24,39,47,48,109,110,111,112,113,116,119,126,128,130,134,154,155,226,317,374,402,431,438,474];
                                break; 
                        case "MIPS-32 Radiation Oncology":
                                mymeasurelist = [102,143,144];
                                break;
                        case "MIPS-33 Rheumatology":
                                mymeasurelist = [24,39,47,110,111,128,130,131,176,177,178,179,180,226,236,238,317,374,402];
                                break;
                        case "MIPS-34 Skilled Nursing Facilty":
                                mymeasurelist = [6,7,8,47,110,118,154,155,181,317,326,474];
                                break;
                        case "MIPS-35 Thoracic Surgery":
                                mymeasurelist = [21,23,47,130,164,165,166,167,168,226,317,358,374,402,445];
                                break;
                        case "MIPS-36 Urgent Care":
                                mymeasurelist = [65,66,91,93,116,130,131,226,317,331,332,333,402,431,464];
                                break;                               
                        case "MIPS-37 Urology":
                                mymeasurelist = [23,47,48,50,102,104,119,128,130,131,226,265,317,358,374,428,429,431,432,433,434];
                                break;
                        case "MIPS-38 Vascular Surgery":
                                mymeasurelist = [21,23,47,128,130,226,236,258,259,260,317,344,345,346,347,357,358,374,402,417,420,441];
                                break;             
...
?>
			<div id="measures">
				<div class="row"><p><span class="align-middle"><input class="btn btn-success btn-sm align-middle" type="submit" value="Update" /></span><span class="align-middle ma-title">MIPS Specialty Sets for 2019</span></p></div>
				<div class="row">
