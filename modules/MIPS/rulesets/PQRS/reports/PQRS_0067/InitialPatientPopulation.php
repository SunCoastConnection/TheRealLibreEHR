<?php
/**
 * PQRS Measure 0067 -- Initial Patient Population
 *
...
class PQRS_0067_InitialPatientPopulation extends PQRSFilter
{
...
" AND (b1.code = codelist_a.code AND codelist_a.type = 'pqrs_0067_a') ".
" AND (b2.code = codelist_b.code AND codelist_b.type = 'pqrs_0067_b' AND b2.modifier NOT IN('GQ','GT','95'));";
