...
class PQRS_0403_InitialPatientPopulation extends PQRSFilter
{
...
" AND (b1.code = codelist_a.code AND codelist_a.type = 'pqrs_0403_a' AND b1.modifier NOT IN('GQ','GT','95'))". 
" AND (b2.code = 'N18.6'); ";
