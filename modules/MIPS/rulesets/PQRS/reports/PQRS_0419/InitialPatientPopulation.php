<?php
/**
 * PQRS Measure 0419 -- Initial Patient Population
 *
...
class PQRS_0419_InitialPatientPopulation extends PQRSFilter
{
...
" AND (b1.code = codelist_a.code AND codelist_a.type = 'pqrs_0419_a' AND b1.modifier NOT IN('GQ','GT','95'))".
