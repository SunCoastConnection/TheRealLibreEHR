<?php
/**
 * PQRS Measure 0069 -- Initial Patient Population
 *
...
class PQRS_0069_InitialPatientPopulation extends PQRSFilter
{
...
" AND (b1.code = codelist_a.code AND codelist_a.type = 'pqrs_0069_a') ".
" AND (b2.code = codelist_b.code AND codelist_b.type = 'pqrs_0069_b' AND b2.modifier NOT IN('GQ','GT','95')); ";
