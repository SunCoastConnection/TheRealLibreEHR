<?php
/**
 * PQRS Measure 0070 -- Initial Patient Population
 *
...
class PQRS_0070_InitialPatientPopulation extends PQRSFilter
{
...
" AND (b2.code = codelist_b.code AND codelist_b.type = 'pqrs_0070_b' AND b2.modifier NOT IN('GQ','GT','95')); ";
