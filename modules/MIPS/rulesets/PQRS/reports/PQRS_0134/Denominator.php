...
class PQRS_0134_Denominator extends PQRSFilter
{
...
" AND (b1.code = codelist_a.code AND codelist_a.type = 'pqrs_0134_b'); ";
// rule-out  This may be reported for all instances
