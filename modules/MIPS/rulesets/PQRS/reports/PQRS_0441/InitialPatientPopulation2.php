<?php
/**
 * PQRS Measure 0441 -- Initial Patient Population 2
 *
...
class PQRS_0441_InitialPatientPopulation2 extends PQRSFilter
{
...
" AND (b1.code = codelist_a.code AND codelist_a.type = 'pqrs_0441_a' AND b1.modifier NOT IN('GQ','GT','95')) ".
" AND b2.code = 'Z85.820'";
