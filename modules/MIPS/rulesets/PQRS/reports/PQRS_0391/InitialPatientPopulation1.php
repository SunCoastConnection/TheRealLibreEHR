<?php
/**
 * PQRS Measure 0391 -- Initial Patient Population 1
 *
...
class PQRS_0391_InitialPatientPopulation1 extends PQRSFilter
{
...
" WHERE b1.pid = ? ".
        ...
        $query .=
" AND fe.date BETWEEN '".$beginDate."' AND '2018-12-01' ".
