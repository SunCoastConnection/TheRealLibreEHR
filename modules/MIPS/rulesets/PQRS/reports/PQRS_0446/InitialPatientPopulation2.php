<?php
/**
 * PQRS Measure 0446 -- Initial Patient Population 2
 *
...
class PQRS_0446_InitialPatientPopulation2 extends PQRSFilter
{
...
" AND (b1.code = codelist_a.code AND codelist_a.type = 'pqrs_0446_a') ".
" AND (b2.code = codelist_b.code AND codelist_b.type = 'pqrs_0446_b');";
