<?php
/**
 * PQRS Measure 0464 -- Initial Patient Population
 *
...
class PQRS_0464_InitialPatientPopulation extends PQRSFilter
{
...
" AND TIMESTAMPDIFF(YEAR,p.DOB,fe.date) BETWEEN '2' AND '12' ".
" AND (b1.code = codelist_a.code AND codelist_a.type = 'pqrs_0464_a')".
" AND (b2.code = codelist_b.code AND codelist_b.type = 'pqrs_0464_b' AND b2.modifier NOT IN('GQ','GT','95')); ";
