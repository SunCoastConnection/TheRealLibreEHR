<?php
/**
 * PQRS Measure 0290 -- Initial Patient Population
 *
...
class PQRS_0290_InitialPatientPopulation extends PQRSFilter
{
...
" AND (b1.code = codelist_a.code AND codelist_a.type = 'pqrs_0290_a' AND b1.modifier NOT IN('GQ','GT','95')) ".
" AND b2.code = 'G20';";
