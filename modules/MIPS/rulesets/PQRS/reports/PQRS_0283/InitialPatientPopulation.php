<?php
/**
 * PQRS Measure 0283 -- Initial Patient Population
 *
...
class PQRS_0283_InitialPatientPopulation extends PQRSFilter
{
...
" AND (b1.code = codelist_a.code AND codelist_a.type = 'pqrs_0283_a' AND b1.modifier NOT IN('GQ','GT','95')) ".
