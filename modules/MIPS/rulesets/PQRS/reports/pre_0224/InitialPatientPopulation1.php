<?php
/**
 * pre Measure 0224 -- Initial Patient Population 1
 *
...
class pre_0224_InitialPatientPopulation1 extends PQRSFilter
{
...
" AND (b1.code = codelist_a.code AND codelist_a.type = 'pqrs_0224_a' AND b1.modifier NOT IN('GQ','GT','95')) ".
