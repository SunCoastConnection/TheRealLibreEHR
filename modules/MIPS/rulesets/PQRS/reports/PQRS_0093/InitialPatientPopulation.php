...
class PQRS_0093_InitialPatientPopulation extends PQRSFilter
{
...
" AND (b2.code = codelist_b.code AND codelist_b.type = 'pqrs_0093_b' AND b2.modifier NOT IN('GQ','GT','95'));";
