<?php
/**
 * pre Measure 0052 -- Initial Patient Population
 *
...
class pre_0052_InitialPatientPopulation extends PQRSFilter
{
...
" AND (b2.code = codelist_b.code AND codelist_b.type = 'pqrs_0052_b' AND b2.modifier NOT IN('GQ','GT','95'));";
//needs premeasure
