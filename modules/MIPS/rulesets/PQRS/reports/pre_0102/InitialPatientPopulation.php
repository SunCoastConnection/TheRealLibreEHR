<?php
/**
 * pre Measure 0102 -- Initial Patient Population
 *
...
class pre_0102_InitialPatientPopulation extends PQRSFilter
{
...
" AND p.sex = 'Male' ".
" AND (b1.code = codelist_a.code AND codelist_a.type = 'pqrs_0102_a') ".
" AND (b2.code = 'C61'); ";
