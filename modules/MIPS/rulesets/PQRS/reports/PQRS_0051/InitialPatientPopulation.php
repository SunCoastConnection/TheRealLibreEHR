...
class PQRS_0051_InitialPatientPopulation extends PQRSFilter
{
...
" AND (b2.code = codelist_b.code AND codelist_b.type = 'pqrs_0051_b' AND b2.modifier NOT IN('GQ','GT','95'));";
