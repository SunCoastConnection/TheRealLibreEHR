...
class PQRS_0265_InitialPatientPopulation extends PQRSFilter
{
...
" AND (b2.code = codelist_b.code AND codelist_b.type = 'pqrs_0265_b' AND b2.modifier NOT IN('GQ','GT','95') ); ";
