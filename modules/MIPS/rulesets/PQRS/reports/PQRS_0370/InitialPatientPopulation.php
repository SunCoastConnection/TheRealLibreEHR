<?php
/**
 * PQRS Measure 0370 -- Initial Patient Population
 *
...
class PQRS_0370_InitialPatientPopulation extends PQRSFilter
{
...
" AND (b1.code = codelist_a.code AND codelist_a.type = 'pqrs_0370_a') ".
" AND (b2.code = codelist_b.code AND codelist_b.type = 'pqrs_0370_b'); ";
