...
<div class="card">
    <div class="col-md-4 pull-right">
        <div class="balloon">
            <div><span class="bal"><i class="Libre-color">☺</i></span></div>
    ...
    <div class="col-md-12 col-xs-12 col-sm-12 text-center">
        <h1 class="Libre-color" style="font-family: Circle;font-size: 50px">
            Congratulations!!!
        </h1>
    </div>
    ...
    <p class="clearfix">
    <div class="col-md-12">
    <h4 class="green" style="font-weight: bolder;">Congratulations! Libre EHR is now installed.</h4>
...
<p class="clearfix"></p>
    <div class="col-md-12 col-sm-12 text-center">
        <a href="./?site=<?php echo $site_id; ?>" class="btn controlBtn btn-group-lg">Click here to start using Libre EHR.</a>
    </div>
    <p class="clearfix"></p>
    <p class="clearfix"></p>
</div>
