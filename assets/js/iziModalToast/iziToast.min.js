...
!function (t, e) {
    ...
    return e.setSetting = function (t, n, o) {
        ...
        var i = this, s = e.getAttribute("data-iziToast-ref"), a = g(this.childrens[s], t || {}),
        ...
        var s = this, a = g(this.childrens[e.getAttribute("data-iziToast-ref")], t || {});
        a.closedBy = i || null, delete a.time.REMAINING, "object" != typeof e && (e = document.querySelector(e)), e.classList.add(n + "-closing"), function () {
        ...
        setTimeout(function () {
            e.parentNode.style.height = "0px", e.parentNode.style.overflow = "", setTimeout(function () {
                delete s.childrens[a.ref], e.parentNode.remove();
                try {
        ...
        s.ref = (new Date).getTime() + Math.floor(1e7 * Math.random() + 1), e.childrens[s.ref] = s;
        var l = {
        ...
        l.toast.setAttribute("data-iziToast-ref", s.ref), l.toast.appendChild(l.toastBody), l.toastCapsule.appendChild(l.toast), function () {
        ...
        !function () {
        ...
        }(), s.message.length > 0 && (s.inputs.length > 0 || s.buttons.length > 0) && (l.p.style.marginBottom = "0"), (s.inputs.length > 0 || s.buttons.length > 0) && (s.rtl ? l.toastTexts.style.marginLeft = "10px" : l.toastTexts.style.marginRight = "10px", s.inputs.length > 0 && s.buttons.length > 0 && (s.rtl ? l.inputs.style.marginLeft = "8px" : l.inputs.style.marginRight = "8px")), function () {
            l.toastCapsule.style.visibility = "hidden", setTimeout(function () {
                var t = l.toast.offsetHeight, e = l.toast.currentStyle || window.getComputedStyle(l.toast),
                    n = e.marginTop;
            ...
            var t = s.position;
            if (s.target) l.wrapper = document.querySelector(s.target), l.wrapper.classList.add(n + "-target"), s.targetFirst ? l.wrapper.insertBefore(l.toastCapsule, l.wrapper.firstChild) : l.wrapper.appendChild(l.toastCapsule); else {
        ...
        try {
            var b = new CustomEvent(n + "-opening", {detail: s, bubbles: !0, cancelable: !0});
