...
!function (t) {
    ...
    var s = t(window), a = t(document), r = "iziModal",
    ...
    return c.prototype = {
        constructor: c, init: function (e, i) {
            ...
            var e = this, o = s.height(), a = this.$element.outerHeight(), d = this.$element.outerWidth(),
                ...
                p = (parseInt(-((this.$element.innerHeight() + 1) / 2)) + "px", this.$wrap.scrollTop()), f = 0;
        ...
        for (var a = this, l = 0; l < a.length; l++) {
            var d = t(a[l]), h = d.data(r), u = t.extend({}, t.fn[r].defaults, d.data(), "object" == typeof e && e);
